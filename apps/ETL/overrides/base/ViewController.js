 ...
 */
Ext.define('ETL.base.ViewController', {
    extend: 'Ext.app.ViewController',

    alternateClassName: 'ETL.ViewController',
    ...
    open: function (target, windowConfig) {
        ...
        if (Ext.isString(target)) itemCfg = Ext.apply({}, {xtype: target}, ETL.ViewController.DEFAULT_ITEM);
        else if (Ext.isObject(target)) {
            itemCfg = Ext.apply({}, target, ETL.ViewController.DEFAULT_ITEM);
        } else {
        ...
        winCfg = Ext.apply({}, windowConfig, ETL.ViewController.DEFAULT_WINDOW);
