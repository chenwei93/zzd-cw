Ext.define('DG.view.bloodconf.BloodConf', {
    extend: 'Ext.grid.Panel',
    xtype: 'bloodconf',

    requires: [
        'DG.view.bloodconf.BloodConfModel',
        'DG.view.bloodconf.BloodConfController',
        'DG.view.bloodconf.ConfPanel',
        'DG.view.bloodconf.BloodConfDetail'
    ],
