Ext.define('Cmdb.view.asset.zcwh.entry.EntryEditFormExt', {
    ...
    items: [
        {
            ...
            items: [{
                ...
                store: {
                    ...
                    proxy: {
                        type: 'ajax',
                        url: 'app/store/data/asset/entry/KFLX.json',
                        reader: {
                            rootProperty: 'array'
                        }
                    }
                ...
                store: {
                    ...
                    proxy: {
                        type: 'ajax',
                        url: 'app/store/data/asset/entry/GXFS.json',
                        reader: {
                            rootProperty: 'array'
                        }
                    }
    ...
    listeners: {
        render: function () {
            ...
            Ext.Ajax.request({
                url: 'app/store/data/asset/entry/ContentType.json',
                success: function (rs) {
            ...
            if (_id != undefined) {
                ...
                Ext.Ajax.request({
                    ...
                    url: 'app/store/data/asset/entry/entryNew.json',
                    success: function (rs) {
                        var data = JSON.parse(rs.responseText);
