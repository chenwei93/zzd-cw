Ext.define('DA.view.dataservice.entrydata.EntryDataList', {
    ...
    requires: [
        'DA.model.EntryData',
        'DA.view.dataservice.entrydata.EntryDataListModel',
        'DA.view.dataservice.entrydata.EntryDataListController',
    ],
