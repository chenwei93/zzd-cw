Ext.define('DA.view.mgr.dictionary.DictionaryController', {
    ...
    onSelect: function (record, view, index) {
        ...
        var store = {
            ...
            proxy: {
                type: 'ajax',
                url1: '/base/api/codes/' + selectName,
                url: 'resources/data/mgr/dictionary/' + selectName + '.json',
                reader: {
                    rootProperty: 'array'
                }
            }
