 ...
 */
Ext.define('AP.base.ViewController', {
    extend: 'Ext.app.ViewController',

    alternateClassName: 'AP.ViewController',
    ...
    open: function (target, windowConfig) {
        ...
        if (Ext.isString(target)) itemCfg = Ext.apply({}, {xtype: target}, AP.ViewController.DEFAULT_ITEM);
        else if (Ext.isObject(target)) {
            itemCfg = Ext.apply({}, target, AP.ViewController.DEFAULT_ITEM);
        } else {
        ...
        winCfg = Ext.apply({}, windowConfig, AP.ViewController.DEFAULT_WINDOW);
